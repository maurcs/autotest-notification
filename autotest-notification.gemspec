Gem::Specification.new do |s|
  ...
  s.files = ["lib/autotest_notification", "lib/autotest_notification/doom.rb", "lib/autotest_notification/mac.rb", "lib/autotest_notification/notify.rb", "lib/autotest_notification/version.rb", "lib/autotest_notification.rb", "images/doom", "images/doom/doom_0.png", "images/doom/doom_1.png", "images/doom/doom_2.png", "images/doom/doom_3.png", "images/doom/doom_4.png", "images/doom/doom_5.png", "images/doom/doom_6.png", "images/fail.png", "images/pass.png", "sounds/doom", "sounds/doom/0.wav", "sounds/doom/1.wav", "sounds/doom/2.wav", "sounds/doom/3.wav", "sounds/doom/4.wav", "sounds/doom/5.wav", "sounds/doom/6.wav", "test/autotest_notification", "test/autotest_notification/test_doom.rb", "test/autotest_notification/test_mac.rb", "test/autotest_notification/test_notify.rb", "test/test_helper.rb", "bin/an-install", "bin/an-uninstall", "bin/playsound", "History.txt", "License.txt", "README.mkdn"]
  s.has_rdoc = true
  ...
  s.test_files = ["test/autotest_notification", "test/autotest_notification/test_doom.rb", "test/autotest_notification/test_mac.rb", "test/autotest_notification/test_notify.rb", "test/test_helper.rb"]
